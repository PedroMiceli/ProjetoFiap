...
public class Lembrete {
    ...
    public Lembrete(int idLembrete, LocalDate dataLembrete, LocalDateTime horaLembrete, String descriçãoLembrete, String tipoLembrete) {
        this.setIdLembrete(idLembrete);
        this.setDataLembrete(dataLembrete);
        this.setHoraLembrete(horaLembrete);
        this.setDescricaoLembrete(descriçãoLembrete);
